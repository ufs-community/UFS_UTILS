...
module grdvars
  ...
  integer, parameter :: nar = 9                                    !< the number of possible ATM resolutions
  integer, parameter, dimension(nar) :: catm = &
       (/12, 18, 24, 48, 96, 192, 384, 768, 1152/)                 !< the ATM resolutions for mapped ocean masks
