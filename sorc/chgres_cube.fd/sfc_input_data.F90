!> @file
!! @brief Read surface data from GRIB2, NEMSIO and NetCDF files.
!! @author George Gayno, Kyle Gerheiser NCEP/EMC

!> Read surface data on the input grid.
...
module sfc_input_data_mod
  ...
  use input_data_utils_mod, only: lsoil_input, read_fv3_grid_data_netcdf, &
       terrain_input_grid, handle_grib_error
