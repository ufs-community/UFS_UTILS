...
URL https://map.nrl.navy.mil/map/pub/nrl/NRLMSIS/NRLMSIS2.1/nrlmsis2.1.zip
URL_HASH SHA256=4b2ef2e9989681d3d5c1eade0c7f91f2050e839b4492d56ba9de21231d635fd8
)
...
add_library(msis2 ${_s}/msis_utils.F90 ${_s}/msis_constants.F90 ${_s}/msis_init.F90 ${_s}/msis_gfn.F90 ${_s}/msis_tfn.F90 ${_s}/msis_dfn.F90 ${_s}/msis_calc.F90 ${_s}/msis_gtd8d.F90)
...
if(BUILD_TESTING)
  add_executable(msis2test ${msis2proj_SOURCE_DIR}/msis2.1_test.F90)
