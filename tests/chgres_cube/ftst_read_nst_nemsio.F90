...
! The expected values for the first and last corner points.
 ...
 data c_d_expected_values / 0.2, 0.2 /
 data c_0_expected_values / 0.1, 0.1 /
 data dt_cool_expected_values / 0.4, 0.4 /
 ...
 data xt_expected_values / 1.2, 1.2 /
 data xtts_expected_values / 1.3, 1.3 /
 data xu_expected_values / 1.4, 1.4 /
 data xv_expected_values / 1.5, 1.5 /
 data xz_expected_values / 1.6, 1.6 /
 data xzts_expected_values / 1.7, 1.7 /
 data zc_expected_values / 1.8, 1.8 /
 data zm_expected_values / 0.0, 0.0 / ! routine returns default value for zm

 print*,"Starting test of read_input_nst_nemsio_file."
