...
!-------------------------------------------------------------------------------------
 ...
 call search_many(num_fields,bundle_search1,dummy_2d,1,field_nums,localpet, &
...
!-------------------------------------------------------------------------------------
 ...
 !Call the search many routine to test search and replace
  call search_many(num_fields,bundle_search2,dummy_2d,1,field_nums,localpet, &
         soilt_climo=soilt_climo,mask=mask_target_search)
...
!-------------------------------------------------------------------------------------
 ...
 call search_many(num_fields,bundle_default1,dummy_2d,1,field_nums,localpet, &
...
!---------------------------------------------
 ...
 call search_many(num_fields,bundle_default2,dummy_2d,1,field_nums,localpet,&
...
! Fill esmf fields for default2 test
 ...
 !Call the search many routine to test behavior for GFS grib2 soil type
 call search_many(num_fields,bundle_3d_search,dummy_2d,1,field_nums,localpet,&
      field_data_3d=dummy_3d,mask=mask_target_search)
