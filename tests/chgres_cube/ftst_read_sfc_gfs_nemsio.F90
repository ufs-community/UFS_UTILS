 program readsfc_gfs_nemsio

! Unit test for the read_input_sfc_gfs_gaussian_nemsio_file routine. 
!
! Reads a 9x9 version of the GFS v14 nemsio history 
...
! values as determined by nemsio library data dump utilities.
!
! Author George Gayno
...
! the input nemsio file using nemsio data dump utilities.
 ...
 data snow_liq_equiv_expected_values / 100.0, 100.0 /
 data snow_depth_expected_values / 1000.0, 1000.0 /
 ...
 data z0_expected_values / 75.0, 75.0 /

 print*,"Starting test of read_input_sfc_gfs_gaussian_nemsio_file."
...
! Call the chgres_cube read routine.
 ...
 end program readsfc_gfs_nemsio
