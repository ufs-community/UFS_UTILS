...
Edit the variables in the 'config' file for your experiment:
     ...
     * **yy/mm/dd/hh**  - The year/month/day/hour of your desired experiment. Use two digits. **NOTE:** *The standard build of chgres_cube does NOT support pre-v14 data. V15 input data is only supported if CDUMP is 'gdas'. To use pre-v14 data or v15 data when CDUMP is 'gfs', contact a repository manager for assistance.*
