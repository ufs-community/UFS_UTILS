...
Edit the variables in the 'config' file for your experiment:
     ...
     * **yy/mm/dd/hh**  - The year/month/day/hour of your desired experiment. Use two digits. **NOTE:** *The standard build of chgres_cube does NOT support experiments prior to June 12, 2019, or if CDUMP is 'gfs', experiments prior to March 21, 2021. To coldstart an experiment prior to these dates, contact a repository manager for assistance.*
