...
case ${MACHINE_ID,,} in
    ...
    ursa)
        ...
        ;;
    gaeac6)
        jobkeep=$(submit_test 01 1 1 5G 0:03:00 normal c6 false snow.hemi snow2mdl.hemi.sh false)
        submit_test 02 1 1 5G 0:03:00 normal c6 false snow.global snow2mdl.global.sh "${jobkeep}"
        ;;
    wcoss2)
